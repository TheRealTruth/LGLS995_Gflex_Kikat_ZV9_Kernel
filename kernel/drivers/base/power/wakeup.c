...
{
	unsigned int cec;
#if defined (CONFIG_MACH_MSM8974_B1_KR) || defined (CONFIG_MACH_MSM8974_Z_KR)|| defined(CONFIG_MACH_MSM8974_B1W) || defined(CONFIG_MACH_MSM8974_Z_OPEN_COM)|| defined(CONFIG_MACH_MSM8974_Z_US)
	...
	if (suspend_marker_entry) {
		if (!wakeup_pending) {
#if defined (CONFIG_MACH_MSM8974_Z_KR) || defined(CONFIG_MACH_MSM8974_Z_OPEN_COM)|| defined(CONFIG_MACH_MSM8974_Z_US)
			split_counters(&cnt, &inpr);
